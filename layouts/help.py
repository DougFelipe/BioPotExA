...
def get_help_layout():
    """
    Returns the layout for the "Help & Support" page, containing only the Common Issues section.

    Returns:
    - dash.html.Div: The full layout of the "Help & Support" page with only the Common Issues section.
    """
    return html.Div(
        className="help-page",
        children=[
