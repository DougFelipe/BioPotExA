...
from utils.data_processing import merge_input_with_database, process_ko_data, merge_with_kegg, process_ko_data_violin,count_ko_per_pathway, count_ko_per_sample_for_pathway
from utils.table_utils import create_table_from_dataframe
from utils.plot_processing import plot_ko_count,create_violin_plot,plot_pathway_ko_counts,plot_sample_ko_counts
...
def initialize_via_dropdown(n_clicks, stored_data):
    ...
    # Preparar os dados para o dropdown
    input_df = pd.DataFrame(stored_data)
    merged_df = merge_with_kegg(input_df)
