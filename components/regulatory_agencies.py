...
def get_regulatory_agencies_layout():
    ...
    return html.Div(
        ...
        children=[
            ...
            html.P(
                "BioPExA provides a comprehensive database that includes compounds identified as priority environmental pollutants. "
            ...
            html.Div(
                ...
                children=[
                    ...
                    html.P(
                        "By focusing on these compounds, BioPExA aims to support global initiatives for environmental sustainability "
            ...
            html.Div(
                ...
                children=[
                    ...
                    html.P(
                        "BioPExA aligns its database and tools with the standards set by these regulatory agencies. "
