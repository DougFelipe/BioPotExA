...
from layouts.gene_pathway_analysis.P1_KO_COUNT import get_ko_count_bar_chart_layout, get_ko_violin_boxplot_layout
from layouts.gene_pathway_analysis.P2_KO_20PATHWAY import get_pathway_ko_bar_chart_layout, get_sample_ko_pathway_bar_chart_layout
from layouts.entity_interactions.P3_compounds_layout import get_compound_scatter_layout
from layouts.rankings.P4_rank_compounds_layout import get_rank_compounds_layout as get_sample_rank_compounds_layout
from layouts.rankings.P5_rank_compounds_layout import get_rank_compounds_layout as get_compound_rank_layout
from layouts.rankings.P6_rank_compounds_layout import get_rank_compounds_gene_layout
from layouts.entity_interactions.P7_compound_x_genesymbol_layoyt import get_gene_compound_scatter_layout
from layouts.entity_interactions.P8_sample_x_genesymbol_layout import get_sample_gene_scatter_layout
from layouts.heatmaps.P9_sample_x_referenceAG_layout import get_sample_reference_heatmap_layout
from layouts.intersections_and_groups.P10_sample_grouping_profile_layout import get_sample_groups_layout
from layouts.heatmaps.P11_gene_sample__heatmap_layout import get_gene_sample_heatmap_layout
from layouts.heatmaps.P12_compaund_pathway_layout import get_pathway_heatmap_layout
from layouts.gene_pathway_analysis.P13_gene_sample_scatter_layout import get_sample_ko_scatter_layout
from layouts.entity_interactions.P14_sample_enzyme_activity_layout import get_sample_enzyme_activity_layout
from layouts.intersections_and_groups.P15_sample_clustering_layout import get_sample_clustering_layout
from layouts.intersections_and_groups.P16_sample_upset_layout import get_sample_upset_layout
from layouts.entity_interactions.P17_gene_compound_network_layout import get_gene_compound_network_layout
from layouts.toxicity.p18_heatmap_faceted_layout import get_toxicity_heatmap_layout
