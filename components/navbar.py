                ...
                html.Div(
                    [
                        ...
                        dbc.Card(
                            dbc.CardBody(
                                [
                                    html.H5("1 - Data Tables and Database Integration", className="card-title"),
                        ...
                        dbc.Card(
                            dbc.CardBody(
                                [
                                    html.H5("2 - Gene and Metabolic Pathway Analysis", className="card-title"),
                        ...
                        dbc.Card(
                            dbc.CardBody(
                                [
                                    html.H5("3 - Interactions Between Entities", className="card-title"),
                        ...
                        dbc.Card(
                            dbc.CardBody(
                                [
                                    html.H5("4 - Ranking and Prioritization", className="card-title"),
                        ...
                        dbc.Card(
                            dbc.CardBody(
                                [
                                    html.H5("5 - Patterns and Interactions with Heatmaps", className="card-title"),
                        ...
                        dbc.Card(
                            dbc.CardBody(
                                [
                                    html.H5("6 - Intersection and Group Exploration", className="card-title"),
                        ...
                        dbc.Card(
                            dbc.CardBody(
                                [
                                    html.H5("7 - Toxicity Predictions", className="card-title"),
